...
[dz1,q1,xi1] = FirstStageDynamics(x,u,t,phase,interp,Throttle,Vehicle,Atmosphere); % Pass primal variables into dynamics simulator
...
[altdot21,londot21,latdot21,fpadot21,vdot21,azidot21, q21, M, Fd, rho,L,Fueldt21,T3,Isp21,q21_aftershock] = SPARTANDynamics(gamma21, alt21, v21,auxdata,zeta21,lat21,lon21,Alpha21,eta21,throttle21, mFuel21,mFuel21(1),mFuel21(end), 1, 0);
...
% phaseout(2).integrand = abs(q21-50000);
%%
